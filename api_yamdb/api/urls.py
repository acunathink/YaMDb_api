...
from .views import (
    CategoriesViewSet, GenresViewSet, RegistrationView, ReviewsViewSet,
    TitlesViewSet, TokenView, UsersViewSet, CommentViewSet
)
...
v1_router.register(r'titles/(?P<title_id>[\d]+)/reviews', ReviewsViewSet)
v1_router.register(
